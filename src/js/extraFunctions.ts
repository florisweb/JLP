...
export function $<Type extends Element = Element>(_string:string):NodeListOf<Type> {
  return document.querySelectorAll<Type>(_string);
}

export function setTextToElement(element:Element, text:string) {
  element.innerHTML = "";
...
export function removeSpacesFromEnds(_str:string):string {
